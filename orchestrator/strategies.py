...
STRATEGIES = {
    "claude": {
        ...
        "initial": 50000.0,
        "style": "Kalite+değer, seçici al + uzun tut (ROE≥%10, F/K≤35, trend üstü); backtest-kalibre",
        "weights": {"Temel": 0.40, "Teknik": 0.35, "Haber": 0.25, "Momentum": 0.0, "Risk": 0.0},
        "buy_threshold": 65.0, "sell_threshold": 40.0,
        "max_single_pct": 0.22, "min_cash_pct": 0.10, "max_sector_pct": 0.40,
        "max_positions": 6, "stop_pct": -0.10, "target_pct": 0.99,
    ...
    "codex": {
        ...
        "initial": 50000.0,
        "style": "Önce risk: düşük vol (ATR≤%3.6), RSI 40-68, MA50 üstü; seçici, uzun tut; backtest-kalibre",
        "weights": {"Temel": 0.35, "Teknik": 0.30, "Haber": 0.20, "Momentum": 0.0, "Risk": 0.15},
        "buy_threshold": 62.0, "sell_threshold": 40.0,
        "max_single_pct": 0.15, "min_cash_pct": 0.12, "max_sector_pct": 0.30,
        "max_positions": 8, "stop_pct": -0.10, "target_pct": 0.40,
    ...
    "microsoft": {
        ...
        "initial": 50000.0,
        "style": "Momentum/trend: 20g değişim≥%4, MA20>MA50 kırılım; kazananı bırak; backtest-kalibre (alfa ~%-2)",
        "weights": {"Temel": 0.20, "Teknik": 0.45, "Haber": 0.15, "Momentum": 0.20, "Risk": 0.0},
        "buy_threshold": 70.0, "sell_threshold": 40.0,
        "max_single_pct": 0.25, "min_cash_pct": 0.05, "max_sector_pct": 0.45,
        "max_positions": 6, "stop_pct": -0.10, "target_pct": 0.40,
